...
def main():
    ...
    #     'trained_models/MM_LLMs_init',
    #     # 'trained_models/MM-LLMs/mm_llms_trainer_forth',
    #     config = model_config,
    #     # load_in_8bit=True,
    ...
    #     target_modules=["q_proj", "k_proj", "v_proj", "out_proj", "fc_in", "fc_out", "wte", "embed_tokens", "lm_head"],
    #     lora_dropout=0.05,
    #     bias="none",
    #     task_type="CAUSAL_LM",
    # )
